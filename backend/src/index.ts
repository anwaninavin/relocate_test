...
import { genderThemeRouter } from "@/routes/genderTheme.routes";
...
import { campusTipsRouter } from "@/routes/campusTips.routes";
...
import { collegesRouter } from "@/routes/colleges.routes";
...
app.use("/api/gender-theme", genderThemeRouter);
...
app.use("/api/campus-tips", campusTipsRouter);
