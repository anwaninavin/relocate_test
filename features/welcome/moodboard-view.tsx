...
function NoteHeadline({ className, children }: { className?: string; children: React.ReactNode }) {
  return (
    <p
...
export function MoodboardView() {
  return (
    <div className={`${caveat.variable} relative overflow-x-hidden bg-[#fdf6ee] text-[#3a2e2a]`}>
        ...
        <div className="mx-auto flex max-w-4xl flex-wrap items-start justify-center gap-8">
          <StickyNote color="yellow" rotate={-6} delay={0}>
            ...
            <p className="mt-1 text-base text-[#5a4a3e] sm:text-lg">
              That&apos;s completely normal, promise.
            </p>
          </StickyNote>
