...
/** Normalizes a webhook wa_id (already E.164 digits without "+") the same way, for comparison. */
export function normalizeWaId(waId: string): string | null {
  return normalizeMobile(waId);
}
