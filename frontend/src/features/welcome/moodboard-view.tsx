...
export function MoodboardView() {
  return (
    <div className="relative overflow-x-hidden bg-[#fdf6ee] text-[#3a2e2a]">
      ...
      {/* 1. HERO */}
      <section className="relative flex min-h-[70vh] flex-col items-center justify-center overflow-hidden px-5 py-14 text-center sm:min-h-screen sm:py-24">
      ...
      {/* 2. MENTAL PREP */}
      <section id="mental-prep" className="relative px-5 py-14 sm:py-24">
      ...
      {/* 4. SURVIVAL HACKS */}
      <section className="relative overflow-hidden px-5 py-16 sm:py-28">
