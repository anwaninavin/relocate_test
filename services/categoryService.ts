 ...
 * unioned with any category strings already present on their checklist items (covers accounts
 * that had checklist data before categories became their own per-user collection).
 */
